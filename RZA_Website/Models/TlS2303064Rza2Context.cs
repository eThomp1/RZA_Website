...
public partial class TlS2303064Rza2Context : DbContext
{
    public TlS2303064Rza2Context()
    {
    }

    public TlS2303064Rza2Context(DbContextOptions<TlS2303064Rza2Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Ticketbooking>(entity =>
        {
            ...
            entity.HasIndex(e => e.CustomerId, "customerID_UNIQUE").IsUnique();
            ...
            entity.HasOne(d => d.Ticket).WithOne(p => p.Ticketbooking)
                .HasForeignKey<Ticketbooking>(d => d.TicketId)
                .OnDelete(DeleteBehavior.ClientSetNull)
